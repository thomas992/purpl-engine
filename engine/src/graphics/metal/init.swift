...
func purpl_metal_init() -> Bool {
	...
	purpl_inst.pointee.wnd = SDL_CreateWindow(purpl_get_initial_window_title(), Int32(SDL_WINDOWPOS_CENTERED_MASK), Int32(SDL_WINDOWPOS_CENTERED_MASK), PURPL_INITIAL_WINDOW_WIDTH, PURPL_INITIAL_WINDOW_HEIGHT, PURPL_DEFAULT_WINDOW_FLAGS.rawValue | SDL_WINDOW_METAL.rawValue)
