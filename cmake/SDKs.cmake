...
function(get_discord_sdk version)
	...
	if (${PURPL_PROCESSOR} MATCHES "x86")
		...
		elseif (${CMAKE_SYSTEM_NAME} MATCHES "Linux")
			message(STATUS "Patching Discord SDK to have correct soname")
			set(DISCORD_SDK_LIBRARY ${DISCORD_SDK_DIR}/lib/${PURPL_PROCESSOR}/discord_game_sdk.so)
			execute_process(COMMAND ${CMAKE_SOURCE_DIR}/tools/patchelf --set-soname discord_game_sdk.so ${DISCORD_SDK_LIBRARY} COMMAND_ECHO STDOUT)
		endif()
