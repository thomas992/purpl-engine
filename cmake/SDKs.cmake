...
function(get_steamworks_sdk)
	...
	if (WIN32)
		set(STEAMWORKS_SDK_LIBRARIES ${CMAKE_BINARY_DIR}/steamworks_sdk/sdk/lib/win64/steam_api.lib PARENT_SCOPE)
		set(STEAMWORKS_SDK_BINARIES ${CMAKE_BINARY_DIR}/steamworks_sdk/sdk/lib/win64/steam_api.dll PARENT_SCOPE)
	elseif (APPLE)
		set(STEAMWORKS_SDK_LIBRARIES ${CMAKE_BINARY_DIR}/steamworks_sdk/sdk/lib/osx/libsteam_api.dylib PARENT_SCOPE)
		set(STEAMWORKS_SDK_BINARIES ${STEAMWORKS_SDK_LIBRARIES} PARENT_SCOPE)
	elseif (${CMAKE_SYSTEM_NAME} MATCHES "Linux")
		set(STEAMWORKS_SDK_LIBRARIES ${CMAKE_BINARY_DIR}/steamworks_sdk/sdk/lib/linux64/libsteam_api.so PARENT_SCOPE)
		set(STEAMWORKS_SDK_BINARIES ${STEAMWORKS_SDK_LIBRARIES} PARENT_SCOPE)
	endif()
endfunction()
