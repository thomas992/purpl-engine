...
include_dirs = {
    ...
    "phnt": [f"deps/{plat}/tmp/phnt$$"] if platform.system() == "Windows" else [] if platform.system() == "Linux" else [],
...
if platform.system() == "Windows":
    outputs = {
        "bgfx": [
            ...
            (f"deps/{plat}/tmp/bgfx/.build/win64_vs2022/bin/bgfx-shared-libRelease.dll",
